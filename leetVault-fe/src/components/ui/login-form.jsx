...
export function LoginFormComponent({ onGoogleSignIn }) {
  ...
  return (
    <div className="w-full max-w-sm p-8 space-y-6 bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 shadow-2xl">
      <div className="text-center space-y-2">
        <h2 className="text-3xl font-bold text-white">Welcome to LeetVault</h2>
        <p className="mt-2 text-sm text-gray-300">Sign in to track your LeetCode progress</p>
      </div>
      ...
      <div className="pt-4">
        ...
        <button
          ...
          className="w-full flex items-center justify-center py-3 px-4 bg-white hover:bg-gray-50 rounded-lg text-gray-800 font-semibold focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 focus:ring-blue-500 transition-all duration-300 shadow-lg hover:shadow-xl"
        >
      ...
      <p className="text-center text-xs text-gray-400 pt-4">
        By signing in, you agree to automate your LeetCode progress tracking
      </p>
    </div>
  );
}
