...
**Curl Command:**
```bash
curl "http://localhost:8000/api/auth/github/install?email=user@example.com"
```
...
**Curl Command:**
```bash
curl "http://localhost:8000/api/github/installations/12345678/repositories"
```
...
**Curl Command:**
```bash
curl -X POST "http://localhost:8000/api/repos/activate" \
  -H "Content-Type: application/json" \
  -d '{
    "email": "user@example.com",
    "installation_id": "12345678",
...
**Curl Command:**
```bash
curl -X DELETE "http://localhost:8000/api/repos/deactivate/user@example.com"
```
...
curl "http://localhost:8000/api/github/installations/YOUR_INSTALLATION_ID/repositories"
